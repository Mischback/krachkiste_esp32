...
function(create_python_venv TARGET)
    ...
    # At least try to work "cross platform". Python's ``venv`` module has
    # subtle differences on Windows.
    if (WIN32)
    ...
    #   - the custom target will be identified by the provided TARGET and may
    #     be used to indicate a dependency on the virtual environment for
    #     other "rules";
    ...
    #     environment; to track the success of this operation, ``pip freeze``
    #     is used to create an output file.
